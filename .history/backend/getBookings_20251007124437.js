...
//BatchGet> prende dal  DB un array di dati completi delle persone con questi ID: G01, G02 e G03 STRUTTURA: { guestId: "G01", name: "Anna", email: "anna@email.com" },/ guestsMap> ORGANIZZA I DATI PRESI CON BATCHGET ti serve per trovare subito chi è G01 nella tabella guests quindi nome e email associati   "G01": { guestId: "G01", name: "Anna", email: "anna@email.com" } / {   bookingId: 1, guestId: "G01", guest: { guestId: "G01", name: "Anna", email: "anna@email.com" } }
